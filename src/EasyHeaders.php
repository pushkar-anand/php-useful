...
class EasyHeaders
{
    ...
    static function base_header(string $userName, string $password)
    {
    ...
    static function origin_header(string $origin)
    {
        header('origin : '.$origin);
    }
    
    static function set_cookie_header(string $cookie)
    {
        header('Set-Cookie : '.$cookie);
    }
    
    static function allow_cross_origin_header(string $paths)
    {
        header('Access-Control-Allow-Origin: '.$paths);
    }
    
    static function build_any_header(string $header)
    {
        header($header);
    }
    
    static function build_any_header(string $type, string $val)
    {
        header($type." : ".$val);
    }
